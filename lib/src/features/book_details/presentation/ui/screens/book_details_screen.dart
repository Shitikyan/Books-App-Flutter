...
class _BookDescriptionSection extends ConsumerWidget {
  final Entry entry;
  final String imgTag;
  final String titleTag;
  final String authorTag;
            ...
            return Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: const Color.fromARGB(0, 54, 2, 2),
...
class _DownloadButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ref.watch(downloadsNotifierProvider).maybeWhen(
      orElse: () {
        return _downloadButton(context, ref);
      },
      data: (books) {
  ...
  Widget _downloadButton(BuildContext context, WidgetRef ref) {
    final isDarkMode = ref.watch(currentAppThemeNotifierProvider).value ==
        CurrentAppTheme.dark;
